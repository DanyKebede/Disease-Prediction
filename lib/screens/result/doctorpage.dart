              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    personalInformation(
                        'assets/images/suitcase.png', hospitaldata.name),
                    personalInformation(
                        'assets/images/mail.png', doctorDetail.email),
                    personalInformation(
                        'assets/images/phone.png', doctorDetail.phone),
                    personalInformation('assets/images/clock.png',
                        '${doctorDetail.hours}hr/day'),
                    doctorDetail.link != null
                        ? personalInformation(
                            'assets/images/linkedin.png', doctorDetail.link!)
                        : const Text(''),
                    Center(
                        child: Container(
                      margin: const EdgeInsets.only(top: 10),
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).pushNamed('/getdirection',
                                arguments: doctorDetail.hospital);
                          },
                          child: const Text(
                            "Get Direction",
                            style: TextStyle(
